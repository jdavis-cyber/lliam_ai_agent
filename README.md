...
- **NotebookLM integration** — stages research documents to Google Drive for source import; reads NotebookLM exports back via Drive MCP
...
| GWS integration | GWS CLI — Gmail, Calendar, Drive, NotebookLM staging |
